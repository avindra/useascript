...
`,se=Object.assign(document.createElement("style"),{type:"text/css",innerText:re});document.head.appendChild(se);var y=document.querySelector(".bg-verse-audio audio");if(y){y.onended=()=>{let t=Array.from(document.querySelectorAll(".actual-verse-navigator a")),e=document.querySelector(".actual-verse-navigator a.active");t[t.length-1]===e?document.querySelector(".chapter-navigator a.next-element").click():e.nextElementSibling.click()};try{y.play()}catch{}}});var N=m(()=>{var ie={childList:!0,subtree:!0},le=()=>{let t=document.body.lastChild;t.firstChild&&t.firstChild.id==="scrollview"&&t.remove()},de=new MutationObserver(le);de.observe(document.body,ie)});var A=m(()=>{var me=`
	body {
...
`,xe=Object.assign(document.createElement("style"),{type:"text/css",innerText:ye});document.head.appendChild(xe);ke=location.pathname.split(/(?!^)\//),M=ke[0];if(["/media"].includes(M)){let t=document.getElementsByTagName("img")[0],e=document.createElement("canvas"),o=e.getContext("2d");t.crossOrigin="anonymous",t=t.cloneNode(!0),t.onload=()=>{e.width=t.naturalWidth,e.height=t.naturalHeight,o.drawImage(t,0,0),e.toBlob(n=>{let c=URL.createObjectURL(n);location.href=c},"image/jpeg",1)}}a(()=>document.querySelector('[aria-controls="multireddits_section"]'),t=>{t.ariaExpanded==="true"&&t.click()});l(()=>{a(()=>document.querySelector("main"),x),a(()=>document.querySelector("shreddit-post-text-body"),x),a(()=>{let t=document.querySelector("shreddit-comment-tree");if(t&&t.scrollHeight>0)return t},x)})});var P,ve,D=i(()=>{d();P=async t=>{a(()=>document.querySelector("header nav"),e=>ve(e,t))},ve=(t,e)=>{let n=t.firstChild.cloneNode(!0),c=document.createTextNode("\u{1F4DC}");n.firstChild.firstChild.replaceWith(c),c.parentNode.style.fontSize="25px";let s=n.querySelector("span");s&&(s.textContent="Useascript",Object.assign(s.style,{fontFamily:"monospace",fontSize:"smaller"})),n.removeAttribute("href"),n.onclick=e,t.prepend(n)}});var H,W=i(()=>{H=t=>{new MutationObserver(()=>{let e=t.querySelectorAll('a[href^="https://t.co"]');for(let o of e){let c=o.innerText.replace(/\s+/g,"").replace(/…$/,"").replace(/^…/,"");c.startsWith("http")&&(o.href=c,o.innerText=c)}}).observe(t,{childList:!0,subtree:!0})}});var h,z,U,G=i(()=>{d();W();h=!0,z=t=>{let e=t?"100%":"600px";a(()=>document.body.querySelector('[data-testid="primaryColumn"]'),o=>{o.style.maxWidth=e,a(()=>{let n=o.querySelector('[aria-level="1"]');if(n){let c=n.parentNode.parentNode;return H(c),c}},n=>n.style.maxWidth=e)}),a(()=>document.body.querySelector('[data-testid="sidebarColumn"]'),o=>o.style.display=h?"none":"block")},U=()=>(l(()=>{z(h)}),()=>{h=!h,z(h)})});var Ce={};var Se,V,F=i(()=>{D();G();Se=U();P(()=>Se());V=document.createElement("style");V.textContent=`
	header > div {
